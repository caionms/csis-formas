"""Módulo para executar detecção via captura de janela."""
...
def main(
    ...
    Args:
        ...
        suspicion_threshold_standing (int): O tempo em segundos para considerar uma presença em
            pé suspeita.
    ...
    if (
        ...
        detect_proximity_with_pose(
            ...
            image_folder_path,
            camera_location,
            suspicion_threshold_standing,
            suspicion_threshold_crouched,
        )
    else:
...
if __name__ == "__main__":
    main(DetectionTypeEnum.GRAFFITI_SPRAY_DETECTION, "Reprodutor Multimídia")
